...
from .patient_views import search_doctors, speciality_detail, register_patients
from .doctor_views import (manage_doctors, create_or_edit_doctor,
                           delete_doctor, load_doctors, get_doctors_by_specialty)
from .speciality_views import (
    manage_specialities, create_or_edit_speciality, delete_speciality, load_specialities, get_specialities
)
